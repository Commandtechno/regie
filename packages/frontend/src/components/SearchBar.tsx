  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-9 pr-9 py-2.5 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-cu-gold/40 focus:border-cu-gold transition-shadow"
      />
      {value && (
        <button
          onClick={() => onChange("")}
